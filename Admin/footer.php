...
<script>
  Swal.fire({
  title: 'สำเร็จ',
  text: 'ลบข้อมูลสำเร็จ | <?php echo $row['mem_name'];?> สำเร็จ',
  icon: 'success',
  confirmButtonText: 'ตกลง'
})
</script>
...
<?php if(isset($_GET['anime_edit'])){ ?>
<script>
  Swal.fire({
  title: 'สำเร็จ',
  text: 'แก้ไขข้อมูลของ | <?php echo $row['a_name'];?> สำเร็จ',
  icon: 'success',
  confirmButtonText: 'ตกลง'
})
</script>
...
<?php if(isset($_GET['anime_del'])){ ?>
<script>
  Swal.fire({
  title: 'สำเร็จ',
  text: 'ลบข้อมูลสำเร็จ | <?php echo $row['a_name'];?> สำเร็จ',
  icon: 'success',
  confirmButtonText: 'ตกลง'
})
</script>
